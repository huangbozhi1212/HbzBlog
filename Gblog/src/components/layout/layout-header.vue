<template>
    <div id="layout-header" :class="{'fixed':fixed,'hidden':hidden}">
        ...
        <div class="site-menus">
            ...
            <div class="menu-item"><router-link to="/tag/0">标签</router-link></div>
            <div class="menu-item"><router-link to="/archived">归档</router-link></div>
            <div class="menu-item"><router-link to="/about">关于我</router-link></div>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            fetchCategory() {
                fetchCategory().then(res => {
                    ...
                    this.category = res.data.TagList
                }).catch(err => {
                    console.log(err)
                })
            }
